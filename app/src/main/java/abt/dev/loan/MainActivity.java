...
public class MainActivity extends AppCompatActivity {
    ...
    * */
    public static final String URL_SAVE_NAME = "http://192.168.0.30/loanApp/saveName.php";
    ...
    public static final String DATA_SAVED_BROADCAST = "abt.dev.datasaved";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        action = findViewById(R.id.floatingActionButton2);
        ...
        action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(), "Ready to open new application", Toast.LENGTH_SHORT).show();
            }
        });
